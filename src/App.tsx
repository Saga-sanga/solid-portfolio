  ...
  return (
    <div class={styles.App}>
      ...
      <section class='min-h-full mt-12 flex flex-col items-center justify-center gap-8'>
        <img class='mask mask-circle border-4 border-primary rounded-full' src={profile} alt="profile image" width={250} height={250}/>
        <h1 class='text-5xl font-bold'>Hello! I'm Reckson Khiangte 👋</h1>
        <h2 class='text-3xl max-w-xl'>I'm a <b>Web Developer</b> who's transitioning into <b>Web3</b>; Currently delving into the exciting world of <b>Blockchain</b> with all it's cutting edge goodness.</h2>
